...
const config: ElementsConfig = {
  ...
  variant: "standalone",
  welcome: {
    title: "Query Sales Insights",
    subtitle: "Generate reports and analyze trends",
    suggestions: [
      {
        title: "Full Report",
        label: "Generate report",
        prompt: "Generate a comprehensive sales report with revenue breakdown, top sellers, and category performance.",
      },
      {
        title: "Top Products",
        label: "Best sellers",
        prompt: "What are our top 5 best-selling products by revenue? Include their category and total units sold.",
      },
      {
        title: "Category Analysis",
        label: "By category",
        prompt: "Break down our sales by category (fresh, organic, specialty). Which category is performing best?",
      },
      {
        title: "Customer Insights",
        label: "Customer data",
        prompt: "Show me customer distribution by country and identify our top markets by order volume.",
      },
    ],
  },
  model: {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex">
          ...
          <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8">
            ...
            {/* Insights Panel + Sales Chart Row */}
            <div className="flex gap-6 mb-8 h-[500px]">
              {/* Elements Insights Panel - 50% width */}
              <div className="w-1/2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="h-full w-full [&>*]:h-full [&>*]:w-full [&>*]:max-w-full">
                  <Chat />
                </div>
              </div>

              {/* Sales Chart - 50% width */}
              <div className="w-1/2 h-full [&>div]:h-full [&_svg]:h-[calc(100%-4rem)]">
